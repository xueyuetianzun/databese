...
public class StudentMenu extends JFrame{
	...
	class JPanelUp extends JPanel {
	    ...
	    public void init() {
	        String sql_message = "select * from student where s_id  = " + input_ID + "; ";
	        Connection conn = Appsu.sendConnection();
	        ...
	        String sql_score = "";
//	        		"select Cname, grade, teacher.name from ssms.student," +
//	                          " student.S_ID = "
//	                                          +
//	                                        "  course.Cno; ";
//	        " ssms.teacher, ssms.course, ssms.score where
//	        + input_ID + " and student.S_ID = score.S_ID and " "score.T_ID = teacher.T_ID and teacher.subject =
           String[][] result = ReturnQueryResult.send(sql_score);
	        String[] head = {"科目", "分数", "老师"};
	        JTable t_score = new JTable(result, head);
	...
	class JPanelBottom extends JPanel {
	    JPanelBottom() {
	        this.setLayout((LayoutManager) new FlowLayout(FlowLayout.CENTER, 60, 10));
	        init();
	    }
	    public void init() {
	        ...
	        button_password.addActionListener(e -> new
	        PasswordDialog(now));
	    ...
	    void init() {
	        ...
	        bt_save.addActionListener(e -> { PreparedStatement pstmt = null; try {
	            ...
	            try {
	                ...
	                pstmt.executeUpdate();
	                JOptionPane.showMessageDialog(this, "修改成功！", "Succeed",
	            ...
	            class AlterDialog extends JDialog {
	                ...
	                void init() {
	                    ...
	                    bt_save.addActionListener(e -> { PreparedStatement pstmt = null; try {
	                        ...
	                        ex.printStackTrace();
	                        JOptionPane.showMessageDialog(this, "格式有误，请重新输入！","Error",
